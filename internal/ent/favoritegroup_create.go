...
func (_c *FavoriteGroupCreate) SetCreatedAt(v time.Time) *FavoriteGroupCreate {
	_c.mutation.SetCreatedAt(v)
	return _c
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (_c *FavoriteGroupCreate) SetNillableCreatedAt(v *time.Time) *FavoriteGroupCreate {
	if v != nil {
		_c.SetCreatedAt(*v)
	}
	return _c
...
func (_c *FavoriteGroupCreate) SetUpdatedAt(v time.Time) *FavoriteGroupCreate {
	_c.mutation.SetUpdatedAt(v)
	return _c
}

// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (_c *FavoriteGroupCreate) SetNillableUpdatedAt(v *time.Time) *FavoriteGroupCreate {
	if v != nil {
		_c.SetUpdatedAt(*v)
	}
	return _c
...
func (_c *FavoriteGroupCreate) defaults() {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		v := favoritegroup.DefaultCreatedAt()
		_c.mutation.SetCreatedAt(v)
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		v := favoritegroup.DefaultUpdatedAt()
		_c.mutation.SetUpdatedAt(v)
	}
}
...
func (_c *FavoriteGroupCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "FavoriteGroup.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "FavoriteGroup.updated_at"`)}
	}
...
func (_c *FavoriteGroupCreate) createSpec() (*FavoriteGroup, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.CreatedAt(); ok {
		_spec.SetField(favoritegroup.FieldCreatedAt, field.TypeTime, value)
		_node.CreatedAt = value
	}
	if value, ok := _c.mutation.UpdatedAt(); ok {
		_spec.SetField(favoritegroup.FieldUpdatedAt, field.TypeTime, value)
	...
	if nodes := _c.mutation.FavoritesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{favoritegroup.FavoritesColumn},
			Bidi:    false,
...
// SetUpdatedAt sets the "updated_at" field.
func (u *FavoriteGroupUpsert) SetUpdatedAt(v time.Time) *FavoriteGroupUpsert {
	u.Set(favoritegroup.FieldUpdatedAt, v)
	return u
}

// UpdateUpdatedAt sets the "updated_at" field to the value that was provided on create.
func (u *FavoriteGroupUpsert) UpdateUpdatedAt() *FavoriteGroupUpsert {
	u.SetExcluded(favoritegroup.FieldUpdatedAt)
	return u
}
...
func (u *FavoriteGroupUpsertOne) UpdateNewValues() *FavoriteGroupUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.CreatedAt(); exists {
			s.SetIgnore(favoritegroup.FieldCreatedAt)
		}
	}))
	return u
}
...
// SetUpdatedAt sets the "updated_at" field.
func (u *FavoriteGroupUpsertOne) SetUpdatedAt(v time.Time) *FavoriteGroupUpsertOne {
...
// UpdateUpdatedAt sets the "updated_at" field to the value that was provided on create.
func (u *FavoriteGroupUpsertOne) UpdateUpdatedAt() *FavoriteGroupUpsertOne {
	return u.Update(func(s *FavoriteGroupUpsert) {
		s.UpdateUpdatedAt()
	})
}
...
// SetUpdatedAt sets the "updated_at" field.
func (u *FavoriteGroupUpsertBulk) SetUpdatedAt(v time.Time) *FavoriteGroupUpsertBulk {
	return u.Update(func(s *FavoriteGroupUpsert) {
		s.SetUpdatedAt(v)
	})
}
...
// UpdateUpdatedAt sets the "updated_at" field to the value that was provided on create.
func (u *FavoriteGroupUpsertBulk) UpdateUpdatedAt() *FavoriteGroupUpsertBulk {
	return u.Update(func(s *FavoriteGroupUpsert) {
		s.UpdateUpdatedAt()
	})
}
