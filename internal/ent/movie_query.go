...
func (_q *MovieQuery) QueryActors() *ActorQuery {
...
func (_q *MovieQuery) QueryTags() *TagQuery {
...
func (_q *MovieQuery) QueryFiles() *FileQuery {
...
func (_q *MovieQuery) QueryFavorites() *FavoriteQuery {
...
func (_q *MovieQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *MovieQuery) FirstIDX(ctx context.Context) int {
...
func (_q *MovieQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *MovieQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *MovieQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *MovieQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *MovieQuery) WithActors(opts ...func(*ActorQuery)) *MovieQuery {
	query := (&ActorClient{config: _q.config}).Query()
...
func (_q *MovieQuery) WithTags(opts ...func(*TagQuery)) *MovieQuery {
	query := (&TagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MovieQuery) WithFiles(opts ...func(*FileQuery)) *MovieQuery {
	query := (&FileClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MovieQuery) WithFavorites(opts ...func(*FavoriteQuery)) *MovieQuery {
	query := (&FavoriteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MovieQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Movie, error) {
	...
	if query := _q.withActors; query != nil {
		if err := _q.loadActors(ctx, query, nodes,
			func(n *Movie) { n.Edges.Actors = []*Actor{} },
			func(n *Movie, e *Actor) { n.Edges.Actors = append(n.Edges.Actors, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTags; query != nil {
		if err := _q.loadTags(ctx, query, nodes,
			func(n *Movie) { n.Edges.Tags = []*Tag{} },
			func(n *Movie, e *Tag) { n.Edges.Tags = append(n.Edges.Tags, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withFavorites; query != nil {
		if err := _q.loadFavorites(ctx, query, nodes,
			func(n *Movie) { n.Edges.Favorites = []*Favorite{} },
			func(n *Movie, e *Favorite) { n.Edges.Favorites = append(n.Edges.Favorites, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *MovieQuery) loadActors(ctx context.Context, query *ActorQuery, nodes []*Movie, init func(*Movie), assign func(*Movie, *Actor)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(actor.FieldID), joinT.C(movie.ActorsPrimaryKey[1]))
	...
	neighbors, err := withInterceptors[[]*Actor](ctx, query, qr, query.inters)
	if err != nil {
		return err
	}
...
func (_q *MovieQuery) loadTags(ctx context.Context, query *TagQuery, nodes []*Movie, init func(*Movie), assign func(*Movie, *Tag)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*Movie)
	nids := make(map[int]map[*Movie]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(movie.TagsTable)
		s.Join(joinT).On(s.C(tag.FieldID), joinT.C(movie.TagsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(movie.TagsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(movie.TagsPrimaryKey[0]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
...
func (_q *MovieQuery) loadFiles(ctx context.Context, query *FileQuery, nodes []*Movie, init func(*Movie), assign func(*Movie, *File)) error {
...
func (_q *MovieQuery) loadFavorites(ctx context.Context, query *FavoriteQuery, nodes []*Movie, init func(*Movie), assign func(*Movie, *Favorite)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Movie)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(favorite.FieldMovieID)
	}
	query.Where(predicate.Favorite(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(movie.FavoritesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *MovieQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(movie.Table, movie.Columns, sqlgraph.NewFieldSpec(movie.FieldID, field.TypeInt))
	_spec.From = _q.sql
